...
function guardarEditar() {
  ...
  //recuperar la informacion ingresada en el formulario
  let idCategory = document.getElementById("idModif").value
...
function guardarBorrar() {
  ...
  let url = "http://localhost:8083/api/Category";
        ...
        registros +=
          '<tr>\
           ...
           "</th>\
            ...
            "</td>" +            
            '<td>\
                <button class="btn" style="background-color: #d3d45f" onclick="editar(' + id + ')">Modificar categorías</button>\
                <button class="btn" style="background-color: #ef6b7a" onclick="eliminar(' + id + ')">Borrar categorías</button>\
            </td>\
            </tr>';
      }
