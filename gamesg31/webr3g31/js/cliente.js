...
*/
  peticion.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      let idLabel = respuesta.idClient
      ...
      document.getElementById("idLabel").value = idLabel
      ...
      document.getElementById("idLabel").innerHTML = "<strong>Farm id :</strong>" + idLabel
...
function guardarEditar() {
  ...
  //recuperar la informacion ingresada en el formulario
  let idLabel = document.getElementById("idLabel").value
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      for (let i in respuesta) {
        ...
        registros +=
          ...
          "</td>" +          
          '<td>\
            <button class="btn"style="background-color: #d3d45f" onclick="editar(' +  id + ')">Modificar cliente</button>\
            <button class="btn" style="background-color: #ef6b7a" onclick="eliminar(' +  id + ')">Eliminar cliente</button>\
          </td>\
          </tr>';
      }
